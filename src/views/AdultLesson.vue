<template>
  <CatchPhrase bg-class="bg-adult">
    <div class="h-80 flex justify-center items-center text-center w-full">Cours pour adultes et adolescents </div>
  </CatchPhrase>
  <section>
    <div class="container mx-auto mb-10">
      <div class="flex flex-wrap align-start justify-start mx-5 md:mx-10 lg:mx-20">
        ...
        <LessonValueBox title="Des cours individuels ou collectifs" class="w-full" color="#2b7d7c" row>
        ...
        <LessonValueBox title="Un plaisir musical immédiat" class="w-full" row color="#2b7d7c">
          Dès le premier cours, les élèves apprennent à jouer un morceau de piano et touchent du doigt leurs premières sensations musicales.<br />
          Contrairement aux idées reçues, il n'y a pas d'âge limite pour commencer à apprendre le piano.<br />
          Vos seules limites étant votre envie et votre volonté.
        </LessonValueBox>

        <LessonValueBox title="Une pédagogie évolutive" class="w-full" color="#2b7d7c" row>
        ...
        <LessonValueBox title="Un répertoire adapté à vos gouts musicaux" class="w-full" color="#2b7d7c" row>
        ...
        <LessonValueBox title="Instruments de cours" class="w-full" color="#2b7d7c" row>
